...
detector.loadModel()
detections = detector.detectObjectsFromImage(input_image="armadilhas/novos_testes2/2.jpg", output_image_path="armadilhas/novos_testes2/teste_2-detected-1.jpg")
