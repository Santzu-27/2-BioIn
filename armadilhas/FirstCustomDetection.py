...
detector.loadModel()
detections = detector.detectObjectsFromImage(input_image="armadilhas/teste/lagarta_teste4.jpg", output_image_path="armadilhas/novos_testes2/lagarta_teste4-detected-new2.jpg")
